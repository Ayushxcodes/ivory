...
@layer utilities {
  .btn_white {
    @apply  border-white bg-white px-8 py-3 text-yellow-50
  }
  .btn_white_text  {
    @apply  border-white bg-white px-8 py-3 text-gray-90
  }
  .btn_yellow  {
    @apply  border-yellow-50 bg-yellow-50 px-8 py-5 text-white
  }
  .btn_dark_yellow {
    @apply  bg-yellow-90 px-8 py-4 text-white transition-all hover:bg-black
  }
  .btn_dark_yellow_outline  {
    @apply border-gray-20 bg-yellow-90 px-8 py-5 text-white
  }
  ...
  /* Get App */
  .get-app {
    @apply max-container relative flex w-full  flex-col justify-between gap-32 overflow-hidden bg-yellow-90 bg-pattern bg-cover bg-center bg-no-repeat px-6 py-12 text-white sm:flex-row sm:gap-12 sm:py-24 lg:px-20 xl:max-h-[598px] 2xl:rounded-5xl;
  }
}
